...
$this->widget('zii.widgets.CDetailView', array(
   ...
   'attributes'=>array(
      ...
      array(
         'name'=>'sNavigation',
         'type' => 'raw',
         'value'=>'<div class="item_link" onclick="parent.window.location = \'' . Yii::app()->controller->createUrl('updateFormMaintenanceWorkingPart&nIdForm=' . $oModelForm->id) . '\'">' . Yii::t('system', 'SYS_NAVIGATION_LINK') . '</div>',
      ),
   ),
