<div class="item-header">
   <div class="item-header-image">
      <img src="<?php echo FApplication::FOLDER_IMAGES_APPLICATION_FRONTEND . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT) . '/events.png' ?>" />
   </div>
   <div class="item-header-text">
      <?php echo FString::castStrToUpper(Yii::t('system', 'SYS_MODULE_DIGITAL_DIARY_MANAGEMENT_HEADER_LINE_EVENTS')); ?>
   </div>
</div>

<div class="item-header-description-padding">
   <?php echo Yii::t('frontend_' . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT), 'PAGE_VIEWEVENTS_DESCRIPTION'); ?>
</div>

<div class="form">
   <?php $formEvents = $this->beginWidget('CActiveForm', array(
      'id'=>'digitaldiary-events-form',
      'action'=>$this->createUrl('frontend/' . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT) . '/report/viewEvents'),
   ...
   <div id="id_form_content">
      <div class="form_header">
         <?php echo Yii::t('frontend_' . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT), 'PAGE_VIEWEVENTS_FORM_LIST_DESCRIPTION'); ?>
      </div>
         ...
         <div class="first_row">
            <div class="cell">
               ...
               <?php $oEmployee = Users::getEmployeeByIdUser(Yii::app()->user->id); 
                     echo $formEvents->dropDownList($oModelForm, 'sEmployee', CHtml::listData(DigitalDiaryFormsTurnEvents::getDigitalDiaryFormsTurnEventsOwner(), 'owner', 'owner'), array('empty'=>Yii::t('system', 'SYS_FORM_COMBOBOX_SELECTION_ELEMENT'), 'style'=>'width:300px;'));
