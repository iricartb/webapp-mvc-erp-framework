<div class="form">
   <?php $formRegion = $this->beginWidget('CActiveForm', array(
      'id'=>'region-form',
      'action'=>$this->createUrl('frontend/' . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT) . '/manage/updateRegion', array('nIdForm'=>$oModelForm->id)),
   ...
   <div class="form_content_popup_modify">
      <div class="form_header">
         <?php echo Yii::t('frontend_' . strtolower(FApplication::MODULE_DIGITAL_DIARY_MANAGEMENT), 'PAGE_UPDATEREGION_FORM_UPDATE_DESCRIPTION'); ?>
      </div>
