...
/**
 * This is the model class for table "form_working_part_employees".
 *
 * The followings are the available columns in table 'form_working_part_employees':
 * @property integer $id
 ...
 */
class FormWorkingPartEmployees extends CActiveRecord {
   
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FormWorkingPartEmployees the static model class
	 */
	...
	public function tableName() {
		return 'form_working_part_employees';
	}
	...
	public function rules() {
		...
		return array(
         ...
         array('name', 'filter', 'filter'=>'ucwords'),
			...
			array('name, business, id_form_working_part', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'name'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMWORKINGPARTEMPLOYEES_FIELD_NAME'),
			'business'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMWORKINGPARTEMPLOYEES_FIELD_BUSINESS'),
   ...
   public static function getFormWorkingPartEmployee($nId) {
      $oFormWorkingPartEmployee = FormWorkingPartEmployees::model()->findByPk($nId);
      
      return $oFormWorkingPartEmployee;
   }
   
   public static function getFormWorkingPartEmployeesByIdFormFK($nIdFormFK) {
      return FormWorkingPartEmployees::model()->findAll('id_form_working_part = ' . $nIdFormFK . ' ORDER BY business ASC, name ASC');   
   }
}