...
/**
 * This is the model class for table "form_maintenance_working_part_ipes".
 *
 * The followings are the available columns in table 'form_maintenance_working_part_ipes':
 * @property integer $id
 ...
 */
class FormMaintenanceWorkingPartIPEs extends CActiveRecord {
	...
	public function tableName() {
		return 'form_maintenance_working_part_ipes';
	}
	...
	public function attributeLabels() {
		return array(
			...
			'name'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMMAINTENANCEWORKINGPARTIPES_FIELD_NAME'),
   ...
   public static function getFormMaintenanceWorkingPartIPE($nId) {
      $oFormMaintenanceWorkingPartIPE = FormMaintenanceWorkingPartIPEs::model()->findByPk($nId);
      
      return $oFormMaintenanceWorkingPartIPE;
   }
   
   public static function getFormMaintenanceWorkingPartIPEsByIdFormFK($nIdFormFK) {
      return FormMaintenanceWorkingPartIPEs::model()->findAll('id_form_maintenance_working_part = ' . $nIdFormFK . ' ORDER BY name ASC');   
   }
}