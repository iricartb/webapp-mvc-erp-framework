...
/**
 * This is the model class for table "form_working_part_risks".
 *
 ...
 */
class FormWorkingPartRisks extends CActiveRecord {
	...
	public function tableName() {
		return 'form_working_part_risks';
	}
	...
	public function attributeLabels() {
		return array(
			...
			'name'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMWORKINGPARTRISKS_FIELD_NAME'),
   ...
   public static function getFormWorkingPartRisk($nId) {
      $oFormWorkingPartRisk = FormWorkingPartRisks::model()->findByPk($nId);
      
      return $oFormWorkingPartRisk;
   }
   
   public static function getFormWorkingPartRisksByIdFormFK($nIdFormFK) {
      return FormWorkingPartRisks::model()->findAll('id_form_working_part = ' . $nIdFormFK . ' ORDER BY name ASC');   
   }
}