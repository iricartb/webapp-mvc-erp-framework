...
/**
 * This is the model class for table "form_special_working_part_prevention_means".
 *
 * The followings are the available columns in table 'form_special_working_part_prevention_means':
 * @property integer $id
 ...
 */
class FormSpecialWorkingPartPreventionMeans extends CActiveRecord {
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FormSpecialWorkingPartPreventionMeans the static model class
	 */
	...
	public function tableName() {
		return 'form_special_working_part_prevention_means';
	}
	...
	public function attributeLabels() {
		return array(
			...
			'name'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSPECIALWORKINGPARTPREVENTIONMEANS_FIELD_NAME'),
   ...
   public static function getFormSpecialWorkingPartPreventionMean($nId) {
      $oFormSpecialWorkingPartPreventionMean = FormSpecialWorkingPartPreventionMeans::model()->findByPk($nId);
      
      return $oFormSpecialWorkingPartPreventionMean;
   }
   
   public static function getFormSpecialWorkingPartPreventionMeansByIdFormFK($nIdFormFK) {
      return FormSpecialWorkingPartPreventionMeans::model()->findAll('id_form_special_working_part = ' . $nIdFormFK . ' ORDER BY name ASC');   
   }
}