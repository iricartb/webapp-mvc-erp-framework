 ...
 *
 * The followings are the available columns in table 'measures':
 * @property integer $id
 ...
 */
class Measures extends CExportedActiveRecord {
   
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Measures the static model class
	 */
	...
	public function rules() {
      ...
      return array(
         ...
         array('visible_default_working_part, visible_default_special_working_part, visible_default_maintenance_working_part, visible_alert_value_yes, visible_alert_value_no, visible_alert_value_np, visible_alert_value_default, required_grade_preventive_action', 'boolean'),
	...
	public function attributeLabels() {
		return array(
			...
			'description'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_DESCRIPTION'),
         'visible_default_working_part'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEDEFAULTWORKINGPART'),
         'visible_default_special_working_part'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEDEFAULTSPECIALWORKINGPART'),
         'visible_default_maintenance_working_part'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEDEFAULTMAINTENANCEWORKINGPART'),
         'alert'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_ALERT'),
         'visible_alert_value_yes'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEALERTVALUEYES'),
         'visible_alert_value_no'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEALERTVALUENO'),
         'visible_alert_value_np'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEALERTVALUENP'),
         'visible_alert_value_default'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_VISIBLEALERTVALUEDEFAULT'),
         'required_grade_preventive_action'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_REQUIREDGRADEPREVENTIVEACTION'),
		   'information'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_MEASURES_FIELD_INFORMATION'),
      );
	}
   ...
   public static function getMeasure($nId) {
      $oMeasure = Measures::model()->findByPk($nId);
      
      return $oMeasure;
   }
   
   public static function getMeasureByDescription($sDescription) {
      $oMeasure = Measures::model()->find('description = \'' . $sDescription . '\'');
      
      return $oMeasure;   
   }
   
   public static function getMeasures($bVisibleWorkingParts = null, $bVisibleSpecialWorkingParts = null, $bVisibleMaintenanceWorkingParts = null) {
      ...
      return Measures::model()->findAll($sCondition);            
   } 
   ...
   public function getExportSpecifications() {
      ...
      $this->oExportSpecifications['data'][7] = array('required_grade_preventive_action', FWidget::TOOLBOX_EXPORTER_DATA_MODEL_DATA_TYPE_BIT, 'Yii::t(\'system\', \'SYS_YES\')', 'Yii::t(\'system\', \'SYS_NO\')', 'Yii::t(\'system\', \'SYS_NO\')'); 
      
      $this->oExportSpecifications['columns'] = array('description', 'visible_default_working_part', 'visible_default_special_working_part', 'visible_default_maintenance_working_part', 'alert', 'visible_alert_value_yes', 'visible_alert_value_no', 'visible_alert_value_np', 'visible_alert_value_default', 'required_grade_preventive_action', 'information');
