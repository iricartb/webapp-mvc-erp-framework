...
/**
 * This is the model class for table "forms_working_parts".
 *
 ...
 * @property integer $equipment_studio_electric
 * @property integer $equipment_studio_instrument
 * @property integer $equipment_studio_mechanic
 * @property string $equipment_studio_others
 ...
 */
class FormsWorkingParts extends CExportedActiveRecord {
   ...
   public function getDbConnection() {
	...
	public function rules() {
		...
		return array(
         ...
         array('fourth_responsible', 'required', 'message'=>Yii::t('system', 'SYS_MODEL_ERROR_EMPTY')),
         ...
         array('equipment', 'length', 'min'=>3, 'max'=>40, 'tooShort'=>Yii::t('system', 'SYS_MODEL_ERROR_TOO_SHORT', array('{1}'=>'3'))),
		   ...
		   array('equipment_studio_electric', 'boolean'),
         array('equipment_studio_instrument', 'boolean'),
         array('equipment_studio_mechanic', 'boolean'),
         ...
         array('equipment', 'YiiConditionalValidator',
			...
			array('id, owner, priority, zone, region, equipment, start_date, data_completed', 'safe', 'on'=>'search'),
		);
	}                                               
	...
	public function relations() {
		...
		return array(
         'employees'=>array(self::HAS_MANY, 'FormWorkingPartEmployees', 'id_form_working_part'),
         'equipment_conditions'=>array(self::HAS_MANY, 'FormWorkingPartEquipmentConditions', 'id_form_working_part'),
         'information_texts'=>array(self::HAS_MANY, 'FormWorkingPartInformationTexts', 'id_form_working_part'),
         'ipes'=>array(self::HAS_MANY, 'FormWorkingPartIPEs', 'id_form_working_part'),
         'measures'=>array(self::HAS_MANY, 'FormWorkingPartMeasures', 'id_form_working_part'),
         'risks'=>array(self::HAS_MANY, 'FormWorkingPartRisks', 'id_form_working_part'),
      );
	}
	...
	public function attributeLabels() {
		return array(
			...
			'owner'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_OWNER'),
			'priority'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_PRIORITY'),
         'priority_number'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_PRIORITYNUMBER'),
			'first_responsible'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_FIRSTRESPONSIBLE'),
			'second_responsible'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_SECONDRESPONSIBLE'),
         'third_responsible'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_THIRDRESPONSIBLE'),
         'fourth_responsible'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_FOURTHRESPONSIBLE'),
         'method_code'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_METHODCODE'),
         'method_description'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_METHODDESCRIPTION'),
         'id_zone'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_IDZONE'),
         'zone'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_ZONE'),
         'id_region'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_IDREGION'),
         'region'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_REGION'),
         'id_equipment'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_IDEQUIPMENT'),
         'equipment'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENT'),
         'equipment_studio_electric'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENTSTUDIOELECTRIC'),
			'equipment_studio_instrument'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENTSTUDIOINSTRUMENT'),
			'equipment_studio_mechanic'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENTSTUDIOMECHANIC'),
			'equipment_studio_others'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENTSTUDIOOTHERS'),
			'equipment_failure_reason'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_EQUIPMENTFAILUREREASON'),
			'failure_reason'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_FAILUREREASON'),
			'failure_solution'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_FAILURESOLUTION'),
			'comments'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_COMMENTS'),
			'status'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_STATUS'),
			'start_date'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_STARTDATE'),
			'end_date'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_ENDDATE'),
         'id_form_work_request'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_IDFORMWORKREQUEST'),
         'sComponents'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_COMPONENT'),
         'sNavigation'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMSWORKINGPARTS_FIELD_NAVIGATION'),
		);
	}
   ...
   public static function getFormWorkingPart($nId) {
      $oFormWorkingPart = FormsWorkingParts::model()->findByPk($nId);
      
      return $oFormWorkingPart;
   }
   
   public static function getRunningFormsWorkingParts() {
      return FormsWorkingParts::model()->findAll('data_completed = 1 AND status <> \'' . FModuleWorkingPartsManagement::STATUS_FINALIZED . '\' ORDER BY start_date DESC');        
   }
   
   public static function getFormsWorkingParts($bDataCompleted = null, $nIdUser = null, $nIdZone = null, $nIdRegion = null, $nIdEquipment = null, $nIdMaintenanceFormTask = null) {
      ...
      return FormsWorkingParts::model()->findAll($sSentence);        
   }
   ...
   public function getExportSpecifications() {
      ...
      $this->oExportSpecifications['columns'] = array('id', 'owner', 'first_responsible', 'second_responsible', 'third_responsible', 'fourth_responsible', 'method_code', 'method_description', 'zone', 'region', 'equipment', 'equipment_failure_reason', 'failure_reason', 'failure_solution', 'comments', 'priority', 'start_date', 'end_date');
