...
/**
 * This is the model class for table "form_notification_working_part_ipes".
 *
 * The followings are the available columns in table 'form_notification_working_part_ipes':
 * @property integer $id
 ...
 */
class FormNotificationWorkingPartIpes extends CActiveRecord {
   
   /**
    * Returns the static model of the specified AR class.
    * Please note that you should have this exact method in all your CActiveRecord descendants!
    * @param string $className active record class name.
    * @return FormNotificationWorkingPartIpes the static model class
    */
   ...
   public function getDbConnection() {
	...
	public function tableName() {
		return 'form_notification_working_part_ipes';
	}
	...
	public function rules() {
		...
		return array(
         ...
         array('name', 'UniqueAttributesValidator', 'with'=>'id_form_working_part', 'message'=>Yii::t('system', 'SYS_MODEL_ERROR_UNIQUE')),
			...
			array('id, name, id_form_notification_working_part', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'name'=>Yii::t('frontend_' . strtolower(FApplication::MODULE_WORKING_PARTS_MANAGEMENT), 'MODEL_FORMNOTIFICATIONWORKINGPARTIPES_FIELD_NAME'),
   ...
   public static function getFormNotificationWorkingPartIPE($nId) {
      $oFormNotificationWorkingPartIPE = FormNotificationWorkingPartIPEs::model()->findByPk($nId);
      
      return $oFormNotificationWorkingPartIPE;
   }
   
   public static function getFormNotificationWorkingPartIPEsByIdFormFK($nIdFormFK) {
      return FormNotificationWorkingPartIPEs::model()->findAll('id_form_notification_working_part = ' . $nIdFormFK . ' ORDER BY name ASC');   
   }
}